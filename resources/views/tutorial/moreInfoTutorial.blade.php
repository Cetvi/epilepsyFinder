        ...
        <main class="w-full lg:w-3/4 space-y-8">
            <section>
                <div class="panel bg-white border border-gray-200 rounded-xl shadow-sm p-6">
                    ...
                    data-intro="To conclude, this table shows you which FastSurfer labels that overlapped with lesion voxels" data-step="1">
                        <thead>
                            <tr class="bg-gray-100" data-intro="Here there is interesting information about all the labels" data-step="2">
                                ...
                                <th class="border border-gray-300 px-4 py-2 text-right" data-intro="Such as the overlapped lesion percentage" data-step="3">Percentage (%)</th>
                            </tr>
                        </thead>
                        <tbody>
                    ...
                    <h2 class="text-2xl font-semibold text-gray-800 mb-6" data-intro="And if you don't know where to find that label or how to classify it here we try to help you to visualize it better!!">Visualization of each classification</h2>
